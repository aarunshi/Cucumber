...
public class TestBase {
	private Logger log = LoggerHelper.getLogger(TestBase.class.getName());
...
//public ThreadLocal<RemoteWebDriver> dr = new ThreadLocal<RemoteWebDriver>();
		...
		public WebDriver getBrowser(String bType) throws MalformedURLException
		{
...
//					driver = new RemoteWebDriver(new URL("http://192.168.0.104:5001/wd/hub"),cap);
...
//driver = dr.get();
	...
	/*
	 * public static void main(String[] args) { TestBase a = new TestBase();
	 * a.before();
	 * 
	 * }
	 */
